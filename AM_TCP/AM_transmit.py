...
class AM_transmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._switch_labels = ['0', '1']
        # Create the combo box
        self._switch_tool_bar = Qt.QToolBar(self)
        self._switch_tool_bar.addWidget(Qt.QLabel("Push" + ": "))
        ...
        self.top_layout.addWidget(self._switch_tool_bar)
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_float, 1, 'tcp://127.0.0.1:50001', 100, False, (-1), '', True)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/tbduy/Downloads/free-sound-1674873702.wav', True)
